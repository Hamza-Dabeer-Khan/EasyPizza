                ...
                <div class="main-menu">
                    <div class="menu-main-nav-menu-container">
                        <ul id="menu-main-nav-menu" class="sf-menu">
                            ...
                            <li class="menu-item"><a href="menu">Pizza composition </a></li>
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-outher">
                        <div class="page-title-inner">
                            ...
                            <h1 class="page-title">Pizza Composition</h1>
                            <div class="clear"></div>
                        </div>
                        <div class="clear"></div>
                    </div>
                            ...
                            <div class="offer-menu-items">
                                <div class="single-offer-category-item isotope-item cat1">
                                    <div class="single-offer-item">
                                        <select name="supplier_id" id="supplier_id" class="wrapper-dropdown single-offer-title">
                                            <option value="Small" class="single-offer-title">Small Size</option>
                                ...
                                <div class="single-offer-category-item isotope-item cat1">
                                    ...
                                    <div class="single-offer-item">
                                        <input type="checkbox" name="customer_ingredient[]" value="{{$menu->ing_id}}" style="float:left">
                                        <div class="single-offer-details">
                                            <div class="single-offer-title">{{ $menu->ing_name }}</div>
                                            <!-- <div class="single-offer-content">
                                                <p>Pineapple, mushrooms, black olives, tomato sauce</p>
                                            </div> -->
                                        </div>
                                        <div class="single-offer-price">${{ $menu->ing_price }}</div>
                                        <div class="clear"></div>
                                    </div>
                                    @endforeach
                                </div>
