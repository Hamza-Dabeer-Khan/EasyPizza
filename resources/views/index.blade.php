        ...
        <div id="header" class="header-wrapper">
                ...
                <div class="main-menu">
                    <div class="menu-main-nav-menu-container">
                        <ul id="menu-main-nav-menu" class="sf-menu">
                            <li class="menu-item menu-item-home current-menu-item current_page_item"><a href="/">Home</a></li>
            ...
            <div class="footer">
                ...
                <div class="footer-content">
                    @ 2017 EasyPizza Made by <a href="http://themeforest.net/user/max-themes/portfolio" title="Pego HTML Themes">Hamza & Ismael</a>.</div>
            </div>
        </div>
