    ...
    <div class="animsition global-wrapper">
        ...
        <div class="mobile-menu-wrapper">
            <div class="menu-main-nav-menu-container">
                <ul id="menu-main-nav-menu" class="sf-menu">
                    <li class="menu-item menu-item-home current-menu-item current_page_item"><a href="index.html">Home</a></li>
                    <li class="menu-item"><a href="#">Ingredients </a></li>
                    <li class="menu-item"><a href="supplier.html">Add Supplier</a></li>
                    <li class="menu-item"><a href="supply.html">Add Supply </a></li>
                    <li class="menu-item"><a href="#">Order</a></li>
                    <!-- <li class="menu-item"><a href="about.html">About us</a></li>
                    <li class="menu-item"><a href="contact.html">Contact</a></li>
                    <li class="menu-item"><a href="blog.html">Blog</a></li> -->
                </ul>
        ...
        <div class="container-wrapper">
            ...
            <div id="container" class="template-contact-container">
                ...
                <div class="clear"></div>
                <div class="page-wrapper" style=" width: 500px !important;">
                    ...
                    <div class="contact-info-wrapper">
                        <div class="contact-form-wrapper">
                            <div role="form" class="wpcf7" id="wpcf7-f49-p15-o1" lang="en-US" dir="ltr">
                                ...
                                <form id="contact-form" action="{{url('add')}}" method="POST">
                                    @csrf
                                    <div class="contact-detail-title">Add Supplier</div>
                                    <div class="albertos-contact-form">
                                        <!-- <select name="type" id="type" class="login-dropdown ">
                                            <option value="Admin" class="single-offer-title">Admin</option>
                                            <option value="Customer" class="single-offer-title">Customer</option>
                                          </select> -->
                                        ...
                                        <div class="clear"></div>
                                        <div class="contact-submit"><input type="submit" value="Add" class="wpcf7-form-control wpcf7-submit" id="add_supplier" /></div>
                                        <div class="clear"></div>
                                        @if($result)
        ...
        <div class="footer2">
            ...
            <div class="footer-content">
                @ 2017 EasyPizza Made by <a href="http://themeforest.net/user/max-themes/portfolio" title="Pego HTML Themes">Pego</a> &amp; <a href="https://html.org/" title="HTML Themes">Hamza & Ismael</a>. </div>
        </div>
    </div>
