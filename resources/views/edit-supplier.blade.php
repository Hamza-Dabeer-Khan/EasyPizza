                    ...
                    <div class="contact-info-wrapper">
                        ...
                        <div class="contact-form-wrapper">
                            <div role="form" class="wpcf7" id="wpcf7-f49-p15-o1" lang="en-US" dir="ltr">
                                ...
                                <form id="contact-form" action="customer.html">
                                        <div class="contact-detail-title">Edit Supplier</div>
                                        ...
                                        <div class="clear"></div>
                                        <div class="contact-submit" ><input type="submit" value="Edit" class="wpcf7-form-control wpcf7-submit"  id="submit_contact" /><div id="msg" class="message"></div></div>
                                    </div>
                                </form>
                            </div>
                        </div>
