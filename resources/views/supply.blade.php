                    ...
                    <div class="contact-info-wrapper">
                        <div class="contact-form-wrapper">
                            <div role="form" class="wpcf7" id="wpcf7-f49-p15-o1" lang="en-US" dir="ltr">
                                ...
                                <form id="contact-form" action="{{url('add-ingredient')}}" method="POST">
                                    @csrf
                                    <div class="contact-detail-title">Add Supply</div>
                                    <div class="albertos-contact-form">
                                        <select name="supplier" id="" class="login-dropdown ">
                                            @foreach($result as $sup)
                                            <option value="{{ $sup->sup_id }}" class="single-offer-title" style="color: white;">{{ $sup->sup_name }}</option>
                                            @endforeach
                                            <!-- <option value="Isamel Irani" class="single-offer-title">Isamel Irani</option> -->
                                        </select>
                                        <div class="app-name"><span class="wpcf7-form-control-wrap name-input">
                                                <input name="ingredient_name" id="ingredient-name" type="text" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Ingredient Name" /></span></div>
                                        <div class="app-phone"><span class="wpcf7-form-control-wrap email-input">
                                                <input name="rg-provenance" id="rg-provenance" type="text" value="" size="40" min="1" max="100" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Regional Provenance" /></span></div>
                                        <div class="app-phone"><span class="wpcf7-form-control-wrap email-input">
                                                <input name="quantity" id="quantity" type="number" value="" size="40" min="1" max="100" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Please Enter quantity" /></span></div>
                                        <div class="app-phone"><span class="wpcf7-form-control-wrap email-input">
                                                <input name="price" id="price" type="number" value="" size="40" min="1" max="100" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Please Enter Price" /></span></div>
                                        ...
                                        <div class="clear"></div>
                                        <div class="contact-submit"><input type="submit" value="Add Supply" class="wpcf7-form-control wpcf7-submit" id="submit_contact" />
                                            <div id="msg" class="message"></div>
                                            @if($flag)
                                        <div class="alert alert-success alert-dismissible">
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                            <strong>Success!</strong> Supplier added sucessfully.
                                        </div>
                                        @endif
                                        </div>
                                    </div>
