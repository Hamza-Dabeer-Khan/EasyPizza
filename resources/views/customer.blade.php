                ...
                <div class="main-menu">
                    <div class="menu-main-nav-menu-container">
                        <ul id="menu-main-nav-menu" class="sf-menu">
                            ...
                            <li class="menu-item"><a href="{{ url('menu') }}">Pizza composition </a></li>
                            <li class="menu-item"><a href="pizzas">Pizzas</a></li>
        ...
        <div class="mobile-menu-wrapper">
            <div class="menu-main-nav-menu-container">
                <ul id="menu-main-nav-menu-1" class="mobile-menu">
                    <li class="menu-item menu-item-home current-menu-items current_page_item"><a href="index">Home</a></li>
