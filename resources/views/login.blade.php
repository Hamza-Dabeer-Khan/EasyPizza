...
<body class="home page-template page-template-template-home page-template-template-home-php page page-id-7">
                ...
                <div class="main-menu">
                    <div class="menu-main-nav-menu-container">
                        <ul id="menu-main-nav-menu" class="sf-menu">
                            <li class="menu-item menu-item-home "><a href="index">Home</a></li>
                    ...
                    <div class="contact-info-wrapper">
                        <div class="contact-form-wrapper">
                            <div role="form" class="wpcf7" id="wpcf7-f49-p15-o1" lang="en-US" dir="ltr">
                                ...
                                <form id="contact-form" action="/pizza-baker">
                                        <div class="contact-detail-title">Log In</div>
                                        ...
                                        <div class="clear"></div>
                                        <div class="contact-submit"><input type="submit" value="Log In" class="wpcf7-form-control wpcf7-submit"  id="submitContact"/></div>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        ...
        var type = $("#type").val();
        if (type == "Admin") {
            window.location.href = "pizza-baker"
        } else {
